...
private:
	...
	float vie;
public:
	inline Bouffee(float _xpos=0, float _ypos=0, float _zpos=0,  float _vie=2, float _taille=1, float _vitesse_x=0, float _vitesse_y=5, float _vitesse_z=0)
	...
	void affiche(Texture*, float x, float y, float z);
};
