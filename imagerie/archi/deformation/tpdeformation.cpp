...
void GeomInit(void) {
	...
	monObjet.charge_OFF((const char*) "plan_33x33.off");
...
void RenderScene(void) {
	...
	maContrainte.centre[0] = 0.2*cos(angle); //translate en x
	maContrainte.centre[1] = 0.2*sin(angle); //translate en y
	maContrainte.centre[2] = 0.2*sin(angle); //translate en z pour le fun
