...
class Level{
public:
	inline Level(){ raw_decor_ground = new int[LVL_WIDTH*LVL_HEIGHT];
					raw_decor = new int[LVL_WIDTH*LVL_HEIGHT];
					}
...
private:
	int* raw_decor_ground; //sol du niveau en char
	int* raw_decor; //reste du decor du niveai en char
	/*
